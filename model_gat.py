...
class GAT(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, num_class, target_class='all'):
        ...
        # GCN convs
        self.gc_type = GATConv(self.hidden_size, ntype)
        self.gc_nschool = GATConv(self.hidden_size, nschool)
        self.gc_ntime = GATConv(self.hidden_size, ntime)
        self.gc_nauthor = GATConv(self.hidden_size, nauthor)
