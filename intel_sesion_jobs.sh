...
python main.py --mode train --workers 0 --model kgm --append gradient --att type   --dir_dataset ../SemArt/ --batch_size 128 --nepochs 300 --embedds bow --clusters 128 --k 100
...
python main.py --mode train --workers 0 --model kgm --append gradient --att school --dir_dataset ../SemArt/ --batch_size 128 --nepochs 300 --embedds clip --clusters 128 --k 100
...
python main.py --mode train --workers 0 --model kgm --append gradient --att type   --dir_dataset ../SemArt/ --batch_size 128 --nepochs 300 --embedds clip --clusters 128 --k 100
...
python main.py --mode train --workers 0 --model kgm --append gradient --att school --dir_dataset ../SemArt/ --batch_size 128 --nepochs 300 --embedds graph --clusters 128 --k 100
...
python main.py --mode train --workers 0 --model kgm --append gradient --att type   --dir_dataset ../SemArt/ --batch_size 128 --nepochs 300 --embedds graph --clusters 128 --k 100
...
python main.py --mode train --workers 0 --model mtl --append gradient --att school --dir_dataset ../SemArt/ --batch_size 128 --nepochs 300 --embedds graph --clusters 128 --k 100
...
python main.py --mode train --workers 0 --model mtl --append gradient --att type   --dir_dataset ../SemArt/ --batch_size 128 --nepochs 300 --embedds graph --clusters 128 --k 100
